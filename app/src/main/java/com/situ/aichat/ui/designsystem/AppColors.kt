...
/**
 * 琉璃主题 · 昼档（冷灰瓷白底 + 钴蓝·见 FABLE5_THEME_LIULI_PROPOSAL.md §4.2）。
 * 只换 text/surface/accent/bubble；status/economy/emotion/pet **沿用暖中性现值**（D-12·复用 [LightAppColors] 子对象）。
 */
val LiuliLightAppColors: AppColors = AppColors(
    isDark = false,
    text = AppTextColors(
        primary = Palette.InkCool,
        secondary = Palette.InkCoolSoft,
        tertiary = Palette.InkCoolFaint,
        onAccent = Palette.White,
    ),
    surface = AppSurfaceColors(
        base = Palette.GlassMist,
        raised = Palette.White,
        sunken = Palette.GlassSunken,
        stroke = Palette.GlassStroke,
        scrim = Palette.Scrim,
        glaze = Palette.GlazeGlass,
        glazeShade = Palette.GlazeGlassShade,
    ),
    accent = AppAccentColors(
        primary = Palette.Cobalt26,
        onPrimary = Palette.White,
        text = Palette.Cobalt26Text,
        container = Palette.Cobalt26Container,
        onContainer = Palette.Cobalt26OnContainer,
        gradientStart = Palette.Cobalt26GradStart,
        gradientEnd = Palette.Cobalt26GradEnd,
        deepStart = Palette.Cobalt26GradEnd,
        deepEnd = Palette.Cobalt26DeepEnd,
        onDeep = Palette.White,
    ),
    bubble = AppBubbleColors(
        userStart = Palette.Cobalt26GradStart,
        userEnd = Palette.Cobalt26GradEnd,
        onUser = Palette.White,
        ai = Palette.White,
        aiStroke = Palette.GlassBubbleStroke,
    ),
...
/** 琉璃主题 · 夜档（近黑非纯黑 D-9 + 提亮钴蓝·见 §4.3）。沿用 [DarkAppColors] 的 status/economy/emotion/pet。 */
val LiuliDarkAppColors: AppColors = AppColors(
    isDark = true,
    text = AppTextColors(
        primary = Palette.MoonWhite,
        secondary = Palette.MoonWhiteSoft,
        tertiary = Palette.MoonWhiteFaint,
        onAccent = Palette.White,
    ),
    surface = AppSurfaceColors(
        base = Palette.NightGlass,
        raised = Palette.NightGlassRaised,
        sunken = Palette.NightGlassSunken,
        stroke = Palette.NightGlassStroke,
        scrim = Palette.Scrim,
        glaze = Palette.GlazeGlassDark,
        glazeShade = Palette.GlazeGlassDarkShade,
    ),
    accent = AppAccentColors(
        primary = Palette.Cobalt26Bright,
        onPrimary = Palette.NightGlass, // 亮档钴蓝 #3B86FF 配深字（白字仅 3.5·同青花 C6 教训）
        text = Palette.Cobalt26TextDark,
        container = Palette.Cobalt26ContainerDark,
        onContainer = Palette.Cobalt26OnContainerDark,
        gradientStart = Palette.Cobalt26GradStart,
        gradientEnd = Palette.Cobalt26GradEnd,
        deepStart = Palette.Cobalt26GradEnd,
        deepEnd = Palette.Cobalt26DeepEnd,
    ...
    bubble = AppBubbleColors(
        ...
        userEnd = Palette.Cobalt26GradEnd,
        onUser = Palette.White,
        ai = Palette.NightGlassBubble,
        aiStroke = Palette.NightGlassStroke,
    ),
